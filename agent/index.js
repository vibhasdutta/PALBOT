...
connect();
startSite({ statePath: STATE_PATH, botWsUrl: config.botWsUrl, onServersChanged, host: config.siteHost, port: config.sitePort, password: config.sitePassword, username: config.siteUsername });
